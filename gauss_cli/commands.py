...
COMMANDS_BY_CATEGORY = {
    ...
    "Workflow": {
        "/prove": "Run the native OpenGauss Lean prove workflow",
        "/draft": "Run the native OpenGauss Lean draft workflow",
        "/review": "Run the native OpenGauss Lean review workflow",
        "/checkpoint": "Run the native OpenGauss Lean checkpoint workflow",
        "/refactor": "Run the native OpenGauss Lean refactor workflow",
        "/golf": "Run the native OpenGauss Lean proof golfing workflow",
        "/autoprove": "Run the native OpenGauss Lean autoprove workflow",
        "/formalize": "Run the native OpenGauss Lean formalize workflow",
        "/autoformalize": "Run the native OpenGauss Lean autoformalize workflow",
