...
def _make_cli(config_overrides=None, env_overrides=None, **kwargs):
    """Create a GaussCLI instance with minimal mocking."""
...
class TestResumeDisplayConfig:
    ...
    def test_default_config_has_resume_display(self):
        """DEFAULT_CONFIG in gauss_cli/config.py includes resume_display."""
        from gauss_cli.config import DEFAULT_CONFIG
